        ...
        <Row>
          ...
          <Col lg="6" md="6">
            <div className="about__content">
              <h2>About Us</h2>
              <p>
                Our global community and our course catalog get better every
                day. Check out our latest numbers as of May 2022.
              </p>
              ...
              <div className="about__counter">
                ...
                <div className=" d-flex gap-5 align-items-center">
                  ...
                  <div className="single__counter">
                    ...
                    <p className="counter__title">Offices Around The World</p>
                  </div>
                </div>
              </div>
            </div>
